...
pub use crate::persistence::work_item_read_repo::WorkItemListQuery;
...
pub async fn list_work_items_page(
    ...
    crate::persistence::work_item_read_repo::list_work_items_page(pool, query).await
}
...
pub async fn list_top_level_work_items_page(
    ...
    crate::persistence::work_item_read_repo::list_top_level_work_items_page(pool, query).await
}
...
pub async fn search_work_items_by_title(
    ...
    crate::persistence::work_item_read_repo::search_work_items_by_title(
        pool, product_id, title, limit,
    )
    .await
}
...
pub async fn summarize_work_items_by_product(
    ...
    crate::persistence::work_item_read_repo::summarize_work_items_by_product(pool).await
}
...
pub async fn summarize_work_items_by_scope(
    ...
    crate::persistence::work_item_read_repo::summarize_work_items_by_scope(pool, product_id).await
}
...
pub async fn update_work_item(
    ...
    let existing = get_work_item(pool, patch.id).await?;
    ...
    sqlx::query("UPDATE work_items SET title=?,description=?,status=?,problem_statement=?,acceptance_criteria=?,constraints=?,updated_at=datetime('now') WHERE id=?")
        ...
        .execute(pool).await?;
    get_work_item(pool, patch.id).await
}
...
pub async fn get_sub_work_items_page(
    ...
    crate::persistence::work_item_read_repo::get_sub_work_items_page(
        pool,
        parent_work_item_id,
        limit,
        offset,
