pub(crate) struct ExampleProductSpec {
    pub(crate) id: &'static str,
    pub(crate) name: &'static str,
    pub(crate) description: &'static str,
    pub(crate) vision: &'static str,
    pub(crate) goals: &'static [&'static str],
    pub(crate) tags: &'static [&'static str],
    pub(crate) product_area: ExampleProductAreaSpec,
}

pub(crate) struct ExampleProductAreaSpec {
    pub(crate) id: &'static str,
    pub(crate) name: &'static str,
    pub(crate) description: &'static str,
    pub(crate) purpose: &'static str,
    pub(crate) capabilities: &'static [ExampleCapabilitySpec],
}

pub(crate) struct ExampleCapabilitySpec {
    pub(crate) id: &'static str,
    pub(crate) name: &'static str,
    pub(crate) outcomes: &'static [&'static str],
    pub(crate) priority: &'static str,
    pub(crate) risk: &'static str,
    pub(crate) technical_notes: &'static str,
}

pub(crate) fn example_product_specs() -> Vec<ExampleProductSpec> {
    vec![
        ExampleProductSpec {
