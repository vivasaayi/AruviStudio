...
pub fn run() {
    ...
    let result = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::product_commands::create_product_area,
            commands::product_commands::list_product_areas,
            commands::product_commands::update_product_area,
            commands::product_commands::delete_product_area,
            commands::product_commands::reorder_product_areas,
            commands::product_commands::create_capability,
            commands::product_commands::list_capabilities,
            commands::product_commands::list_product_capabilities,
            commands::product_commands::get_capability,
            ...
            commands::product_commands::summarize_product_tree,
