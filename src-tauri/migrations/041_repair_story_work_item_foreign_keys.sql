...
ALTER TABLE workflow_runs RENAME TO workflow_runs_story_fk_legacy;
ALTER TABLE agent_runs RENAME TO agent_runs_story_fk_legacy;
ALTER TABLE approvals RENAME TO approvals_story_fk_legacy;
ALTER TABLE artifacts RENAME TO artifacts_story_fk_legacy;
ALTER TABLE findings RENAME TO findings_story_fk_legacy;
ALTER TABLE agent_model_calls RENAME TO agent_model_calls_story_fk_legacy;
ALTER TABLE model_calls RENAME TO model_calls_story_fk_legacy;
ALTER TABLE external_cli_runs RENAME TO external_cli_runs_story_fk_legacy;
ALTER TABLE external_cli_run_events RENAME TO external_cli_run_events_story_fk_legacy;
ALTER TABLE delivery_items RENAME TO delivery_items_story_fk_legacy;
ALTER TABLE agent_work_items RENAME TO agent_work_items_story_fk_legacy;
ALTER TABLE agent_work_evidence RENAME TO agent_work_evidence_story_fk_legacy;
ALTER TABLE work_items RENAME TO work_items_story_fk_legacy;
...
INSERT INTO work_items SELECT * FROM work_items_story_fk_legacy;
INSERT INTO workflow_runs SELECT * FROM workflow_runs_story_fk_legacy;
INSERT INTO agent_runs SELECT * FROM agent_runs_story_fk_legacy;
INSERT INTO approvals SELECT * FROM approvals_story_fk_legacy;
INSERT INTO artifacts SELECT * FROM artifacts_story_fk_legacy;
INSERT INTO findings SELECT * FROM findings_story_fk_legacy;
INSERT INTO agent_model_calls SELECT * FROM agent_model_calls_story_fk_legacy;
INSERT INTO model_calls SELECT * FROM model_calls_story_fk_legacy;
INSERT INTO external_cli_runs SELECT * FROM external_cli_runs_story_fk_legacy;
INSERT INTO external_cli_run_events SELECT * FROM external_cli_run_events_story_fk_legacy;
INSERT INTO delivery_items SELECT * FROM delivery_items_story_fk_legacy;
INSERT INTO agent_work_items SELECT * FROM agent_work_items_story_fk_legacy;
INSERT INTO agent_work_evidence SELECT * FROM agent_work_evidence_story_fk_legacy;

DROP TABLE agent_work_evidence_story_fk_legacy;
DROP TABLE agent_work_items_story_fk_legacy;
DROP TABLE delivery_items_story_fk_legacy;
DROP TABLE external_cli_run_events_story_fk_legacy;
DROP TABLE external_cli_runs_story_fk_legacy;
DROP TABLE model_calls_story_fk_legacy;
DROP TABLE agent_model_calls_story_fk_legacy;
DROP TABLE findings_story_fk_legacy;
DROP TABLE artifacts_story_fk_legacy;
DROP TABLE approvals_story_fk_legacy;
DROP TABLE agent_runs_story_fk_legacy;
DROP TABLE workflow_runs_story_fk_legacy;
DROP TABLE work_items_story_fk_legacy;
