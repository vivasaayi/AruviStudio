...
import { filterReferencesForProductBook, filterReferencesForScope } from "../lib/productReferences";
import { WorkItemTree } from "./ProductOverviewDelivery";
import { styles } from "./ProductOverviewDocument.styles";
import { ProductOverviewProductAreaChapter } from "./ProductOverviewProductAreaChapter";
      ...
      <div style={styles.article}>
        ...
        {!isLoading ? (
          (tree?.product_areas ?? []).map((productAreaTree, index) => (
            <ProductOverviewProductAreaChapter
